...
耀:  # 作品链接：https://github.com/jinyaoMa
  ...
  手机: +1234567890
  求职意向:
  - Web开发，主要目的是想要加深对Web开发以学知识的理解和拓展，希望能够更深入学习。对Web前后端基础知识特别熟悉，很有信心能够在Web开发类的岗位得到能力的快速提升。
  - 移动开发，主要目的是想多样技能，在软件领域得到更全面的发展。对iOS和Android都很有兴趣，在校时iOS和Android的基础课目分数较高，相信自己能够胜任移动开发类的岗位。
  教育背景:
    莫霍克学院:
      软件开发:  # 专科 2015.09 – 2019.12
        简介: 1/3 Web开发，1/3 编程与设计基础，1/3 其他（包括iOS, Android, 机械学习等基础）
        满分课目: 新兴Web技术（包括CodeIgniter, Vue, Laravel）, Android应用开发，ASP.NET应用开发，HTML5移动Web开发，PHP与JavaScript基础
      学术类通用英语:  # 专科 2014.09 – 2015.09
        简介: 培养演讲展示、标准写作、标准发音、快速阅读、速听速记等英语语言技能
  专业技能:
    编程语言:
      常用: HTML, CSS, PHP, JavaScript, Java
      了解: Swift, Python 3, XML, VB, C, C#
    框架架构: 
      常用: jQuery
      了解: CodeIgniter, Vue, Bootstrap, Laravel
    其他知识: 
      常用: Node.js, Oracle SQL/Transact SQL/MySQL, Git, Hexo
      了解: Redis, MVC, UML, Selenium, GML, Adobe Photoshop
    编程软件: 
      用过: Notepad++, NetBeans, Visual Studio, Android Studio, XCode
  项目经验:
    个人博客:  # 个人项目 2018.12 – 进行中.
      为加强软件领域知识的理解和进阶，博客由Hexo进行生成，其中主题布局为个人设计，外加功能插件使用多个外接API，最后做出带个人风格的博客。
    网站活动监控:   # 课目实验 2018.09 – 2018.12
      为理解并熟练使用Vue和Node.js，实验通过单页面动态刷新做到实时快速地监控网站状态，最后达到追查和监控用户IP和网站连接状态的效果。
    数据库管理网站:  # 课目实验 2017.09 – 2017.12
      为熟练使用SQL Server和Visual Studio，实验通过使用多个便利的控件和SQL实现CRUD能，最后达到管理数据库的效果。后来使用CodeIgniter重写加入登录功能。
  义工经验:
    验票员:  # 2015.04 – 2015.05
      多伦多国际电影节连续守门验票一周
